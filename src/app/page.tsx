...
export default function Home() {
  return <main className={styles.page} id="top"><div className={styles.canvas}>
    ...
    <footer className={styles.footer} id="bantuan"><a className={styles.brand} href="#top"><Icon name="pulse" /><span><strong>heartbeats</strong><small>A safer ride, a better tomorrow.</small></span></a><nav aria-label="Navigasi footer"><a href="#fitur">Fitur</a><a href="#perangkat">Cara Kerja</a><a href="#harga">Harga</a><a href="#bantuan">Bantuan</a></nav><p><Icon name="pulse" />Motor aman.<br /><span>Cerita lebih banyak lagi esok.</span></p></footer>
  </div></main>;
}
